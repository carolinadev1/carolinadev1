...
<div style="display: flex; align-items: center; margin-bottom: 15px;">
  ...
  />
  <p style="margin: 0;">• Java está sendo um divisor de águas extremamente positivo. É uma linguagem única que me faz gostar justamente mais do backend. Matenho os meus códigos com propósito e cada vez mais aprendizados com orientação a objetos. Java realmente é uma linguagem que vale a pena programar, estou gostando bastante, colocando o que aprendo aqui. </p>
</div>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 15px;">
  ...
  <div>
    ...
    <p style="margin-top: 5px; margin-bottom: 0;">• OBS: A distro que uso atualmente é o Linux Mint. É ótima para quem vem diretamente do Windows e ter um ambiente simples, minimalista. É ótimo programar e ter o conhecimento sobre esse sistema operacional leve e tranquilo.</p>
  </div>
</div>
